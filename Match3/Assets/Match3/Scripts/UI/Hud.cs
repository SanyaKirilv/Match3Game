...
namespace Match3
{
    public class Hud : MonoBehaviour
    {
        ...
        private void Start ()
        {
            for (int i = 0; i < stars.Length; i++) stars[i].enabled = i == _starIndex;
        }
        ...
        public void SetScore(int score)
        {
            ...
            for (int i = 0; i < stars.Length; i++) stars[i].enabled = (i == visibleStar);
        ...
        public void OnGameLose(int score) => gameOver.ShowLose(score);
    }
}
